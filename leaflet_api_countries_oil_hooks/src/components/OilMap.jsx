...
const OilMap = ({countries}) => {
    ...
    const oneEchCountry = (country, layer)=>{
        ...
        layer.bindPopup(`
            ...
            <hr>
            <p class="popup-quant">${confirmedText} Mbbl/Y</p>
            <p class="popup-quant">${dailyP} Mbbl/D</p>
            `);
    }
  ...
  return (
    <MapContainer className="map-container-style" zoom={2} center={[30,40]}> 
     <div className="sidebar">
        ...
        <p className='world-info-legend text-info-legend'>Annual World production: <strong>30629 Mbbl</strong></p>
        <p className='info-legend-conv text-info-legend center-text'>1 Mbb = 1,000,000 barrels</p>
        <p className='text-info-legend center-text'>1 barrel =  158.98 liters</p>
